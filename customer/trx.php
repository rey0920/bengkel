					...
					<div class="panel-body">
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								<?php
								$i = 1;
								$sql = "SELECT trx.*, konsumen.*, users.* FROM trx, konsumen, users WHERE trx.id_kon=konsumen.id_kon AND trx.id_kasir=users.id and id_kasir='$sess_csid' ORDER BY trx.tgl_trx DESC";
								...
								while ($data = mysqli_fetch_array($ress)) {
									...
									echo '<td class="text-center">
												...
												'; ?>
									<a href="trx_cetak.php?id=<?php echo $data['id_trx']; ?>" target="_blank" class="btn btn-info btn-xs">Cetak</a>
