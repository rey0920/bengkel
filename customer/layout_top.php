			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="../foto/<?php echo $sess_csfoto; ?>" width="20px" height="20px" padding="0px">&nbsp;&nbsp;<?php echo ucfirst($sess_csname); ?>&nbsp;<i class="fa fa-caret-down"></i>
					</a>
					<ul class="dropdown-menu dropdown-user">
						<li><a href="pengaturan.php"><i class="fa fa-lock fa-fw"></i>&nbsp;Ganti Password</a></li>
						<li class="divider"></li>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<ul class="nav nav-second-level">
							<?php
							if ($pagedesc == "Pesan Jasa") {
								echo '<li><a href="trx_baru.php" class="active">Pesan Jasa</a></li>';
							} else {
								echo '<li><a href="trx_baru.php">Pesan Jasa</a></li>';
							}
							?>
							<?php
