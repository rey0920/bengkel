                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							...
							<?php
							if(isset($menuparent) && $menuparent == "mekanik") {
								echo '<li class="active">';
							}
							else {
								echo '<li>';
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-asterisk fa-fw"></i>&nbsp;Data Mekanik<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Data Mekanik") {
										echo '<li><a href="mekanik.php" class="active">Data Mekanik</a></li>';
									}
									else {
										echo '<li><a href="mekanik.php">Data Mekanik</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						</li>
