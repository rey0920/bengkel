<?php
	...
	$sql = "SELECT * FROM kasir WHERE id_kasir ='". $sess_kasirid ."'";
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<input type="hidden" name="password_old2" value="<?php echo $data['pass_kasir'] ?>">
											<input type="hidden" name="id_pengguna" value="<?php echo $data['id_kasir'] ?>">
										</div>
									</div>
									<div class="form-group">
