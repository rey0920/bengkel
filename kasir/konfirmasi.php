            ...
            <div class="col-md-12" style="padding-top: 20px;">
                <table id="table" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $i = 1;
                        $grand = 0;
                        $sql = "SELECT tmp_trx.*, barangjasa.*, users.id, users.nama as nama_user FROM tmp_trx, barangjasa, users WHERE tmp_trx.id_brg=barangjasa.id_brg AND tmp_trx.id_kasir=users.id and status!='Batal' and status!='On Process'";
                        $ress = mysqli_query($conn, $sql);
                        while ($data = mysqli_fetch_array($ress)) { ?>
                            <tr>
