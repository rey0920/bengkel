...
<head>
	...
	<title>Sistem Informasi Media Workshop - <?php echo $pagedesc ?></title>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="foto/bengkel.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Media Workshop</strong></div>
			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="pengaturan.php"><i class="fa fa-lock fa-fw"></i>&nbsp;Ganti Passowrd</a></li>
						<li class="divider"></li>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h4>Sistem Informasi Media Workshop</h4>
							<h5 class="text-muted"><i class="fa fa-calendar fa-fw"></i>&nbsp;<?php echo $hari_ini . ", " . $tanggal . " " . $bulan_ini . " " . $tahun ?></h5>
						</li>
						<?php
						if ($pagedesc == "Dashboard") {
							echo '<li><a href="index.php" class="active"><i class="fa fa-home fa-fw"></i>&nbsp;Dashboard</a></li>';
						} else {
						...
						<a href="#"><i class="fa fa-user fa-fw"></i>&nbsp;Data Supplier<span class="fa arrow"></span></a>
						...
						?>
						<!-- open <li> tag generated with php, see line 155-160 -->
						<a href="#"><i class="fa fa-th-large fa-fw"></i>&nbsp;Barang Masuk dan Jasa<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php
						...
						<ul class="nav nav-second-level">
							...
							?>
							<?php
							if ($pagedesc == "Konfirmasi Transaksi") {
								echo '<li><a href="konfirmasi.php" class="active">Konfirmasi Transaksi</a></li>';
							} else {
								echo '<li><a href="konfirmasi.php">Konfirmasi Transaksi</a></li>';
							}
							?>
						</ul><!-- /.nav-second-level -->
						</li>
